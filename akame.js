        ...
        if (tebakasahotak.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await akame.sendButtonText(m.chat, [{
                    ...
                    type: 1
                }], `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, , fakestatus)
                delete tebakasahotak[m.sender.split('@')[0]]
...
• Wit : ${wit}`
            ...
            await akame.sendButtonText(m.chat, buttons, anu, ,)
            }
            break
            case 'command': {
               let simple = `┌────────┈❖
...
└──────────────┈❖`
                ...
                rows: [
                {title: "⌲ 「 Sewa Bot 」", rowId: `${prefix}sewabot`, description: `siw bezwen achte bot la`}
                ]
                },
                {
                title: "Open Donasi >_<",
                rows: [
                {title: "⌲ 「 Open Donasi 」", rowId: `${prefix}donasi`, description: ` Support Creator Guys`}
                ]
                },
                {
                ...
                rows: [
                {title: "⌲ 「 Chat Owner 」", rowId: `${prefix}owner`, description: `ekri kreyate bot la`}
                ]
                },
                {
                title: "Thanks To >_<",
                rows: [
                {title: "⌲ 「 Contributor 」", rowId: `${prefix}tqtt`, description: `Moun ki patisipe nn kreyasyon bot la !!`}
                ]
                }
                ]
                akame.sendListMsg(m.chat, simple, , `Hello Everyone !`, `Click Here`, sections, floc)
            }
            break
            case 'sc':
            case 'script': {
            ...
            case 'tebakmenu': {
				...
				akame.sendListMsg(m.chat, `*Silahkan Pilih Menu Dibawah Ini*`, , `TEBAK MENU`, `Click Here`, menuss, floc)
			}
            break
            case 'tebak': {
                if (args[0] === "lagu") {
                    ...
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                        ...
                        akame.sendButtonText(m.chat, [{
                            ...
                            type: 1
                        }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, , fakestatus)
                        delete tebaklagu[m.sender.split('@')[0]]
                    }
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
                ...
                await akame.sendButtonText(m.chat, buttons, jawab, , fakestatus, {
                    mentions: ments
                })
            }
            break
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            case 'tagmenu': {
			 let tagg = [
				...
				{title: "Si Ganteng bak tuan Putra", rowId: `gantenggrup`, description: `Ganteng sekaliii tuan putra ini :D`},
				 ...
				 akame.sendListMsg(m.chat, `*Menu tag seseorang yg si paling...*`, , `TAG MENU`, `Click Here`, tagg, floc)
				 }
				break
            case 'bebangrup': {
			if (!m.isGroup) throw mess.group
            ...
            let buttaons = [
                    ...
                    await akame.sendButtonText(m.chat, buttaons, teks, , fakestatus, {mentions: meanst})
                    }
            break
			case 'babigrup': {
			if (!m.isGroup) throw mess.group
            ...
            let buttns = [
                    ...
                    await akame.sendButtonText(m.chat, buttns, ters, , fakestatus, {mentions: meansrt})
                    }
            break
			case 'kerengrup': {
			if (!m.isGroup) throw mess.group
            ...
            let butons = [
                    ...
                    await akame.sendButtonText(m.chat, butons, texx, , fakestatus, {mentions: mesrt})
                    }
            break
			case 'cantikgrup': {
			if (!m.isGroup) throw mess.group
            ...
            let butons1 = [
                    ...
                    await akame.sendButtonText(m.chat, butons1, vio1, , fakestatus, {mentions: men1})
                    }
            break
			case 'gantenggrup': {
			if (!m.isGroup) throw mess.group
            ...
            let butons2 = [
                    ...
                    await akame.sendButtonText(m.chat, butons2, vio2, , fakestatus, {mentions: men2})
                    }
            break
			case 'pintargrup': {
			if (!m.isGroup) throw mess.group
            ...
            let butons3 = [
                    ...
                    await akame.sendButtonText(m.chat, butons3, vio3, , fakestatus, {mentions: men3})
                    }
            break
			case 'wibugrup': {
			if (!m.isGroup) throw mess.group
            ...
            let butons4 = [
                    ...
                    await akame.sendButtonText(m.chat, butons4, vio4, , fakestatus, {mentions: men4})
                    }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
 ...
 🗞️ *Pesan : ${q ? q : 'kosong'}*\n\n`
            ...
            case 'antilink': {
                ...
                if (args[0] === "on") {
                    ...
                    await akame.sendButtonText(m.chat, buttons, `Mode ${command} 🕊️`, `Silahkan Klik Button Dibawah, Jika Button Tidak Muncul Ketik ${command} on/off`, , fgclink)
                }
            }
            break
            case 'antilinkyt': {
            ...
            case 'mute': {
                ...
                if (args[0] === "on") {
                    ...
                    m.reply(`${} telah di mute di group ini 🕊️`)
                } else if (args[0] === "off") {
                    if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya 🕊`)
                    db.data.chats[m.chat].mute = false
                    m.reply(`${} telah di unmute di group ini 🕊️`)
                } else {
                    let buttons = [{
                            buttonId: 'mute on',
                            buttonText: {
            ...
            case 'ephemeral': {
                ...
                akame.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, , `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, floc)
                }
            }
            break
...
©${akame.user.id}`
            ...
            await akame.sendButtonText(i, buttons, txt, ,)
                }
		...
		for (let yoi of anu) {
		    await sleep(1500)
		              let txt = `「 Broadcast Bot 」\n\n${text}`
                      let buttons = [{ buttonId: 'command', buttonText: { displayText: '📖Simple Menu' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖All Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await akame.sendButtonText(yoi, buttons, txt, ,)
                }
		m.reply('Sukses Broadcast')
         ...
         break
	       ...
	       break     
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            akame.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${}.mp3`}, { quoted : fvn })
            }
            break
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(db.data.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await akame.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, , m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await akame.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, , m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await akame.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, , m)
                } else {
                    let id = + new Date
                    ...
                    await akame.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, , m)
                }
                break
            }
            ...
            case 'nulis': {
                ...
                akame.sendListMsg(m.chat, `*Silahkan Pilih Menu Dibawah Ini*`, , `NULIS MENU`, `Click Here`, sections, floc)
              }
            break
            case 'nuliskiri': {
            ...
            case 'infobot': {
                ...
                txtping += `*👤 creator Name :* ${global.namaowner}\n`
                txtping += `*🕊️ Nama Bot :* ${global.namabot}\n`
                txtping += `*🔗 Nomor creator :* wa.me/${global.owner}\n\n`
                ...
                txtping += `*🎗️ WhatsApp :* wa.me/${global.owner}\n`
                    .trim()
                let buttons = [{ buttonId: 'command', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖All Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await akame.sendButtonText(m.chat, buttons, txtping, ,)
            }
            break
            case 'speed':
            case 'speedtest': {
            ...
            case 'owner': case 'creator': {
                const _0x53d5a1=_0x27a5;function _0x1462(){const _0xbe3016=['12uYHjID','208fygsPF','END:VCARD','2931pmexYt','chat','item2.EMAIL;type=INTERNET: andysebastien14@gmail.com\x0a','owner','item1.TEL;type=CELL;type=VOICE;waid=50941411147:+509\x41411147\x0a','BEGIN:VCARD\x0a','5414050UngFlr','ORG:andymrlit;\x0a','106vqkniK','item3.X-ABLabel:TikTok\x0a','N:;andymrlit\x20creator;;;','item1.X-ABLabel:Creator\x20Andy\x20-\x20MD\x0a','11977850TbeEvp','4721KSYLYP','2327066mcQmla','3292794BrTbVz','andymrlit','item4.X-ABLabel:Region\x0a','sendContact','5082320iACHTF'];_0x1462=function(){return _0xbe3016;};return _0x1462();}function _0x27a5(_0x35959a,_0x59c18c){const _0x146279=_0x1462();return _0x27a5=function(_0x27a522,_0x5d48a4){_0x27a522=_0x27a522-0x1d1;let _0x1a2418=_0x146279[_0x27a522];return _0x1a2418;},_0x27a5(_0x35959a,_0x59c18c);}(function(_0x4e6b4a,_0xc2511f){const _0x82151d=_0x27a5,_0x596f5d=_0x4e6b4a();while(!![]){try{const _0x4cc183=parseInt(_0x82151d(0x1d3))/0x1*(-parseInt(_0x82151d(0x1e5))/0x2)+-parseInt(_0x82151d(0x1dd))/0x3*(-parseInt(_0x82151d(0x1db))/0x4)+parseInt(_0x82151d(0x1e3))/0x5+-parseInt(_0x82151d(0x1da))/0x6*(-parseInt(_0x82151d(0x1d4))/0x7)+parseInt(_0x82151d(0x1d9))/0x8+-parseInt(_0x82151d(0x1d5))/0x9+-parseInt(_0x82151d(0x1d2))/0xa;if(_0x4cc183===_0xc2511f)break;else _0x596f5d['push'](_0x596f5d['shift']());}catch(_0x32be5a){_0x596f5d['push'](_0x596f5d['shift']());}}}(_0x1462,0x9758c));let vcard=_0x53d5a1(0x1e2)+'VERSION:3.0\x0a'+_0x53d5a1(0x1e7)+'FN:andymrlit\x20Creator\x0a'+_0x53d5a1(0x1e4)+_0x53d5a1(0x1e1)+_0x53d5a1(0x1d1)+_0x53d5a1(0x1df)+'item2.X-ABLabel:Email\x0a'+'item3.URL:https://tiktok.com/@andymrlit\x0a'+_0x53d5a1(0x1e6)+'item4.ADR:;;Jepang;;;;\x0a'+_0x53d5a1(0x1d7)+_0x53d5a1(0x1dc);akame['sendMessage'](m[_0x53d5a1(0x1de)],{'contacts':{'displayName':_0x53d5a1(0x1d6),'contacts':[{'vcard':vcard}]}},{'quoted':fkontak}),akame[_0x53d5a1(0x1d8)](m[_0x53d5a1(0x1de)],global[_0x53d5a1(0x1e0)],fkontak);
            }
            break
            case 'bug':
            case 'report': {
                if (!text) return m.reply(`Mau Lapor Apa?\n\nContoh: ${command} Menu Error`)
                akame.sendMessage(`50941411147@s.whatsapp.net`, {
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                akame.sendListMsg(m.chat, `Please select the menu you want to change!`, , `Hello Owner !`, `Click Here`, sections, floc)
                }
            }
            break
            case 'rules': {
...
┌┤「 RULES BOT 」
│└─────────────┈❖
│1. Tanpri itilize 5 Dezyèm Reta
│   Pou itilize BOT.
│2. San Lisans Cuilk Bot? Gwoup
│   Wi Cave Coup .
│2. Sèvi ak sajès.
│3. Pa rele bot.
│4. Pa Spam Bot.
...
┌┤「 SNK 」
│└─────────────┈❖
│1. Done whatsapp ou yo 
│  pral save toutotan 
│   bot la disponib.
│2. Done w yo pral efase
 |Lè BOT OFF.
│3. Nou pa sove imaj/
 |Videyo/Fichiye/Odyo/Dokiman
 |Sa w voye.
 |4. Nou pa janm mande
 |Ou Pou Bay
 |Enfomasyon pèsonèl.
 |5. Si Jwenn BUG/ERÈ
 |Tanpri kontakte andymrlit
└┬─────────────┈❖
┌┤「 ATTENTION 」
│└─────────────┈❖
│1. Bot pral bloke nimewo w.
│2. Ou pa kapab.
│Aksè Bots ankò.
│3. Esplwate kont bots.
│Sanksyon: BLOK PERMANAN
└──────────────┈❖`
...
│「 ${ucapanWaktu} 」
└┬─────────────┈❖
┌┤「 konbyen kob nap vann bot la 」
│└─────────────┈❖
│⭔ 1 pou on mois 80 dola
│⭔ pou 15 joun 40 dola
└┬─────────────┈❖
┌┤「 PEMBAYARAN 」
│└─────────────┈❖
...
┌┤「 DONASI 」
│└─────────────┈❖
│⭔ creator : ${global.telkomsel}
│⭔ XL : ${global.xl}
│⭔ andymrlit : ${global.indosat}
│⭔ paypal : ${global.tri}
│⭔ pap padap : ${global.smartfren}
│⭔ mon cash : ${global.gopay}
│⭔ mon cash : ${global.dana}
│⭔ null : ${global.ovo}
│⭔ SAWERIA : ${global.saweria}
│⭔ Q.S andymrlit 7 :
│
...
│
│⭔ Artinya : si nou ta renmn enstale
│bot la nap bezwen 60 dola haitien 
│siw ta renmn ankouraje kreyate a 
│pa bliye send on ti money 
│sa t met on 25 gdes
│ *bonne journée*
└──────────────┈❖`
                let buttons = [{ buttonId: 'command', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖All Menu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '➡️Chat Owner' }, type: 1 }]
...
┌┤「 NOTE 」
│└─────────────┈❖
│• yoo ${global.namabot}, me c yon bot 
│  Beta Multi-Device WhatsApp.
│• kreye pa andymrlit ki la pou 
│ edew siw ta jwenn yon bug pa neglije
│  kontakte propriétaire a bot 
│  pou w k edel repare bug la
│  pase yon bon joune 
└┬─────────────┈❖
┌┤「 INFO BOT 」
│└─────────────┈❖
...
└──────────────┈❖`
        ...
        if ((m.mtype === 'groupInviteMessage' || budy.startsWith('https://chat') || budy.startsWith('Buka tautan ini')) && !m.isBaileys && !m.isGroup) {
			...
			akame.sendMessage(m.chat, { text:`INVITE DETECT\n\nMau masukin bot ini ke group kamu?`, title: 'LINK GROUP DECTETED', footer: ' © 2022 andymrlit', buttons: buttons, headerType: 5 })
		}
                if (budy.startsWith('=>')) {
