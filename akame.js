...
module.exports = akame = async (akame, m, chatUpdate, store) => {
    try {
        ...
        //Time Menuju Ulang Tahun Untuk AndyMrlit :)
...
const ftroli = {
    ...
    "message": {
        orderMessage: {
            ...
            orderTitle: 'Please Follow TikTok @andymrlit',
...
const fgclink = {
    ...
    "message": {
        "groupInviteMessage": {
            "groupJid": "50941411147-1635036556@g.us",
            "inviteCode": "https://chat.whatsapp.com/FGmVjFYJBjjGst62qwNKJB",
            "groupName": "andy bot md v3",
            "caption": '©AndyMrlit',
            'jpegThumbnail': thumb
        }
    }
...
const fkontak = {
    ...
    message: {
        'contactMessage': {
            'displayName': 'AndyMrlit Creator',
            'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;AndyMrlit Creator;;;\nFN:AndyMrlit Creator\nitem1.TEL;waid=50941411147:50941411147\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
            'jpegThumbnail': thumb,
            thumbnail: thumb,
            sendEphemeral: true
        }
...
const fakestatus = {
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await akame.updateProfileStatus(`I am Andymd-Bot | Aktif Selama ${uptime} | Mode : ${akame.public ? 'Public-Mode' : 'Self-Mode'} | User : ${Object.keys(global.db.data.users).length} | Jangan Telp Bot | © Created Andymrlit-Kun`).catch(_ => _)
...
⭔ romeo.
⭔ hpi 
⭔ sad boy neg ki pa regle anyn an.
⭔ Penyedia Module.
⭔ Penyedia Res Api's.
⭔ All My Friends.
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'infobot': {
                ...
                txtping += `*🕊️ Nama Bot :* andy md v3`
                txtping += `*🔗 Nomor Owner :* wa.me/$50941411147`
                ...
                txtping += `*🎗️ WhatsApp :* wa.me/50941411147`
                    .trim()
                let buttons = [{ buttonId: 'command', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖All Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            ...
            case 'owner': case 'creator': {
                const _0x53d5a1=_0x27a5;function _0x1462(){const _0xbe3016=['12uYHjID','208fygsPF','END:VCARD','2931pmexYt','chat','item2.EMAIL;type=INTERNET:andysebastien14@gmail.com\x0a','owner','item1.TEL;type=CELL;type=VOICE;waid=50941411147:+62\x41-41-11-47\x0a','BEGIN:VCARD\x0a','5414050UngFlr','ORG:andymrlit;\x0a','106vqkniK','item3.X-ABLabel:TikTok\x0a','N:;andymrlit\x20Creator;;;','item1.X-ABLabel:Creator\x20andymrlit\x20-\x20MD\x0a','11977850TbeEvp','4721KSYLYP','2327066mcQmla','3292794BrTbVz','Andymrlit','item4.X-ABLabel:Region\x0a','sendContact','5082320iACHTF'];_0x1462=function(){return _0xbe3016;};return _0x1462();}function _0x27a5(_0x35959a,_0x59c18c){const _0x146279=_0x1462();return _0x27a5=function(_0x27a522,_0x5d48a4){_0x27a522=_0x27a522-0x1d1;let _0x1a2418=_0x146279[_0x27a522];return _0x1a2418;},_0x27a5(_0x35959a,_0x59c18c);}(function(_0x4e6b4a,_0xc2511f){const _0x82151d=_0x27a5,_0x596f5d=_0x4e6b4a();while(!![]){try{const _0x4cc183=parseInt(_0x82151d(0x1d3))/0x1*(-parseInt(_0x82151d(0x1e5))/0x2)+-parseInt(_0x82151d(0x1dd))/0x3*(-parseInt(_0x82151d(0x1db))/0x4)+parseInt(_0x82151d(0x1e3))/0x5+-parseInt(_0x82151d(0x1da))/0x6*(-parseInt(_0x82151d(0x1d4))/0x7)+parseInt(_0x82151d(0x1d9))/0x8+-parseInt(_0x82151d(0x1d5))/0x9+-parseInt(_0x82151d(0x1d2))/0xa;if(_0x4cc183===_0xc2511f)break;else _0x596f5d['push'](_0x596f5d['shift']());}catch(_0x32be5a){_0x596f5d['push'](_0x596f5d['shift']());}}}(_0x1462,0x9758c));let vcard=_0x53d5a1(0x1e2)+'VERSION:3.0\x0a'+_0x53d5a1(0x1e7)+'FN:Andymrlit\x20Creator\x0a'+_0x53d5a1(0x1e4)+_0x53d5a1(0x1e1)+_0x53d5a1(0x1d1)+_0x53d5a1(0x1df)+'item2.X-ABLabel:Email\x0a'+'item3.URL:https://tiktok.com/@andymrlif\x0a'+_0x53d5a1(0x1e6)+'item4.ADR:;;Jepang;;;;\x0a'+_0x53d5a1(0x1d7)+_0x53d5a1(0x1dc);akame['sendMessage'](m[_0x53d5a1(0x1de)],{'contacts':{'displayName':_0x53d5a1(0x1d6),'contacts':[{'vcard':vcard}]}},{'quoted':fkontak}),andymd[_0x53d5a1(0x1d8)](m[_0x53d5a1(0x1de)],global[_0x53d5a1(0x1e0)],fkontak);
            }
            break
            case 'bug':
            case 'report': {
...
┌┤「 SNK 」
│└─────────────┈❖
│1. Done Whatsapp ou yo pral nou
│Sove sou sèvè nou an
│Osi lontan ke BOT la aktif.
...
│
│⭔ Artinya :siw ta bezwen mete
│ mete bot la sou Whatsapp
│paw la kontakte andymrlit
│ men pa bliye tou mache ak 50 dola
└──────────────┈❖`
                let buttons = [{ buttonId: 'command', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖All Menu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '➡️Chat Owner' }, type: 1 }]
            await akame.sendButtonText(m.chat, buttons, anu, akame.user.name, fkontak)
            }
...
┌┤「 NOTE 」
│└─────────────┈❖
│• Je suis ${global.botname}, ce bot est
│Bêta WhatsApp multi-appareils.
│créer par andymrlit
│• Si vous trouvez une sorte
│Bug ou erreur s'il vous plaît
│Naturellement oui, tapez le rapport
│Signaler le propriétaire à immédiatement
